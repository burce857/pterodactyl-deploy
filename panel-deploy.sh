...
# ============================================================
# Pterodactyl Panel + Blueprint + Nebula 一鍵部署 v21
# Ubuntu 22.04 / 24.04
# ============================================================
...
echo "============================================================"
echo " Pterodactyl Panel + Blueprint + Nebula 一鍵部署 v21"
echo "============================================================"
...
echo
echo "ℹ️ v21 UI-only 模式：只安裝 Blueprint Framework + Nebula UI"
...
echo "ℹ️ v21：暫停自動安裝 Logs 類擴充：mclogs / consolelogs / laravellogs"
info "安裝 Nebula"
